...
// Script File Runner for Cronicle
// Modified from  'Shell Script' Plugin
// Modified by Jon Seale
...
stream.on('json', function(job) {
	// got job from parent 
    	var script_file = job.params.script;
	var args = JSON.parse("[" + job.params.args + "]");
	
	var child = cp.spawn( script_file, args, { 
